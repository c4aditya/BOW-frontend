...
const Placement = () => {
  return (
    ...
    <div className="our-placement-text">
            ...
            <p><span>4. Networking Opportunities:</span><br></br>Networking is a powerful tool in job searching. Birds of the world Aviation Training Institute connects you with industry professionals through workshops, seminars, and networking events. These opportunities allow you to build valuable connections, gain insights into industry trends, and potentially find job leads.Direct interactions with industry professionals and leaders.
